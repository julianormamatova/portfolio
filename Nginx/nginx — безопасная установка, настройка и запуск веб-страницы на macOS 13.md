...
**Важно**: Во время установки **Homebrew** запрашивается пароль администратора (sudo), так как требуются права (root) для установки в системные директории. Вводить пароль администратора следует только при уверенности в источнике скрипта.
...
brew install nginx
```
![Установка nginx](images/Image_1.png)
*Рисунок 1. Установка nginx (версия 1.27.5)*
...
```
![Запуск nginx](images/Image_2.png)
*Рисунок 2. Запуск nginx*

4. Проверить статус (должно быть `started`):
```
brew services list
```
![Успешный запуск](images/Image_3.png)
*Рисунок 3. Успешный запуск nginx*
...
![Проверка работоспособности nginx*](images/Image_4.png)
*Рисунок 4. Проверка работоспособности nginx*
...
![путь к конфигурационному файлу*](images/Image_5.png)
*Рисунок 5. Информация об установленном nginx, включая путь к корневой директории (Docroot) и путь к конфигурационному файлу*

4. Открыть конфигурационный файл с помощью текстового редактора **VS Code**:
```
...
![Настройка виртуального хоста](images/Image_6.png)
*Рисунок 6. Настройка виртуального хоста*

6. Проверить синтаксис конфигурационного файла **nginx.conf**:
```
sudo nginx -t
```
![Проверка синтаксиса](images/Image_7.png)
*Рисунок 7. Проверка синтаксиса nginx.conf*
...
```
![Наполнение файла](images/Image_8.png)
*Рисунок 8. Наполнение файла базовым HTML-кодом*

3. Нажать на иконку файла в левой панели проводника:
![Навигация по файлам в левой панели](images/Image_9.png)
*Рисунок 9. Навигация по файлам в левой панели VS Code*

4. Нажать **Open Folder** для настройки корневой директории файла:
![Настройка корневой директории HTML-файла](images/Image_10.png)
*Рисунок 10. Настройка корневой директории HTML-файла*

5. Выбрать **Рабочий стол** и папку **mywebsite**:
![Указание корневой директории в папке mywebsite](images/Image_11.png)
*Рисунок 11. Указание корневой директории в папке mywebsite*

6. Нажать **Save** для сохранения файла в папке **mywebsite**:
![Сохранение HTML-файла](images/Image_12.png)
*Рисунок 12. Сохранение HTML-файла в папке mywebsite*

7. Сохранить как **index.html** с расширением HTML:
![Сохранение файла с расширением HTML](images/Image_13.png)
*Рисунок 13. Сохранение файла с расширением HTML*

8. В папке **mywebsite** проверить наличие файла **index.html**.

# 8. Просмотр веб-страницы

1. Просмотреть веб-страницу в браузере по адресу — http://localhost
![Успешный просмотр веб-страницы в браузере*](images/Image_14.png)
*Рисунок 14. Успешный просмотр веб-страницы в браузере*
