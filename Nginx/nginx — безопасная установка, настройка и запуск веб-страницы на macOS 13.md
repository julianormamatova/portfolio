...
![Проверка_работоспособности_nginx*](Image_4.png)
...
![Путь_к_конфигурационному_файлу*](Image_5.png)
...
![Настройка_виртуального_хоста](Image_6.png)
...
sudo nginx -t
```
![Проверка_синтаксиса](Image_7.png)
...
![Успешный_просмотр_страницы_в_браузере*](Image_14.png)
