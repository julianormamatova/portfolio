...
brew install nginx
```
![Установка_nginx](images/Image_1.png)
...
```
![Запуск_nginx](images/Image_2.png)
...
brew services list
```
![Успешный_запуск](images/Image_3.png)
...
![Проверка_работоспособности_nginx*](images/Image_4.png)
...
![Путь_к_конфигурационному_файлу*](images/Image_5.png)
...
![Настройка_виртуального_хоста](images/Image_6.png)
...
sudo nginx -t
```
![Проверка_синтаксиса](images/Image_7.png)
...
![Успешный_просмотр_страницы_в_браузере*](images/Image_14.png)
