...
![Проверка работоспособности nginx*](Image_4.png)
...
![путь к конфигурационному файлу*](Image_5.png)
...
![Настройка виртуального хоста](Image_6.png)
...
sudo nginx -t
```
![Проверка синтаксиса](Image_7.png)
...
![Успешный просмотр веб-страницы в браузере*](Image_14.png)
